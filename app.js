...
function setupDigitDistributionLayout() {
  ...
  /*
    Force digits 0–9 into one
    horizontal row.

    This is done here so you do
    NOT need to edit CSS manually.
  */
...
function renderDigitDistribution() {
  /*
    Re-apply horizontal layout
    every time the distribution
    is refreshed.
  */
...
function initialize() {
  ...
  */
  ...
  /*
    Keep the interface synchronized.
  */
